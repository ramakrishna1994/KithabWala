...
<div class="container">
	...
	<center>	<h3><font color="#ffd00d"><b>Buy Our Books in</b></font></h3></center>
	</div>
	<br>
	<div class="row" >
		<iframe width="100%" height="250" frameborder="0" style="border:0" src="https://www.google.com/maps/embed/v1/place?q=place_id:ChIJS31UbIOayzsRIOTQth4RTtM&key=AIzaSyClwxVxJQq8InSrT-CJm9FXmtoLTcuhzuk" allowfullscreen></iframe>
	</div>
</div>

<div class="container">
		<div class="row" style="margin-top:2%">
	<center>	<h3><font color="#ffd00d"><b>Store Locations</b></font></h3></center>
	</div>
  ...
  <table class="table">
    ...
    <tbody>
      <tr class="warning">
        <td>1</td>
        <td>Kithabwala Book Store</td>
        <td>9848022338</td>
		<td>Hyderabad</td>
        <td>Plot:A/255,Maithrivanam</td>
      </tr>
...
<!-- TRADE ENQUIRIES SECTION -->
    ...
    <div class="fixed_queries_content inner">
        ...
        <ul class="nav nav-tabs" >
            <li role="presentation" class="first"><a aria-controls="home" role="tab" data-toggle="tab">Shop Keeper</a></li>
            <li role="presentation" class="last"><a aria-controls="profile" role="tab" data-toggle="tab">Sponsor</a></li>
        </ul>
